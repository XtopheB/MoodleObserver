...
date <-  20210301 #20210217  #20210201     # 20210127
...
learners %>%
 ggplot() +
 aes(x = NbAct, y = TotalTime, color = Country) +
...
mutate(TotalTime = TotalTime/60) %>%
 ggplot() +
 aes(x = TotalTime, y = TotalTest, colour = Country, fill = User.full.name) +
 geom_jitter( width = 0.5, height = 0.5, alpha = 0.6) +
