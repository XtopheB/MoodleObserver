...
AllCoursesStartDate <-c("2022-05-25", "2022-01-24", "2022-06-06", "2022-07-04", "2022-08-01", "2022-09-26", "2022-11-21", "2023-01-16")
...
data.feedback[,1:10] <- data.feedback[, 1:14] %>%
...
all.fig <- (G_K | G_C) /(G_E | G_Q) / (G_D | G_U) 
all.fig  + 
