...
# label(vars(one_of('Knowledge', 'Content', 'Efficiency','Quality', 'Design', 'Usefulness'  ))) <- c("A",)
...
# Get corpus.R
corpus.R <- iconv(data.feedback$Results)

corpus.R <- corpus.R(VectorSource(corpus.R))
...
tdm <- TermDocumentMatrix(cleanset.R)
tdm <- as.matrix(tdm)
