...
```
 ...
 > *The graphic exhibits few access differences among tye **`r length(unique(course.log$Actname))`** activities proposed, except webinar's videos (replays) and optional activities such as the project.  Most activities were accessed by **`r MedianLearnersActivity`** or more learners.*
