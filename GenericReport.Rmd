...
CourseName <- "Gender_Self_1"     ##  "DTV20"  or DV22
CourseNameLong <- "Using gender data for analysis, communications and policy making in the context of SDG monitoring and beyond"

CourseStartDate <-"2022-05-25"
NbModules <-3    # 6   
# Minimum to get the certificate
GradeThreshold <- 70  

# Dates parameters
 WebinarDay = 1 # Sunday is 1
...
ggplot() +
 ...
 ggtitle("Learners registered by date (Cumulative)") +
...
MyDataFrames <- list('Grades' = DTCertified%>% arrange(desc(TotalReal)),
                     'ByCountry' = CertifiedCountryW%>% arrange(desc(.[[2]])),
                     'BySex' = CertifiedSex)

write.xlsx(MyDataFrames,
