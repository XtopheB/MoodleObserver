...
#                         "Principles of Reproducible Analytical Pipelines for Official Statistics ")
# 
# AllCoursesStartDate <-c("2022-05-25", "2022-01-24", "2022-06-06", "2022-07-04", "2022-08-01", "2022-09-26", "2022-11-21", "2023-01-16", "2023-07-03", "2023-11-27", "2024-04-29", "2024-06-01", "2024-08-12", "","2025-01-20", "2025-02-17")
# 
# AllCoursesNbModules <-c(3,6,6,5,5,7,8,6,7,8, 5, 4, 6, 6, 6, 4 )
```
...
# i.course <- 10 # MLOS23
# i.course <- 11 #RAP2024
#i.course <- 12 # MasterClass 24
# i.course <- 13 # User Engagement 24
# i.course <- 14  # Dataviz
# i.course <- 15 # Admin 2025
# i.course <- 16 # RAP 2025

```


```{r CourseList}
# Create the data frame directly with raw values
# AllCourses <- tibble(
#   Id = 1:16,
#   Ref = c("Gender_Self_1", "DTV20_S", "MLOS_S", "HealthStats2", "SEEA_CF_2022", 
#           "SBR22", "MLOS22", "ClimateChange2023", "user_2023", "egriss_2023", 
#           "ADV23", "2023-MLOS", "RAP2024", "user_2024", "2025-UAD-F-1", "RAP"),
#   Name = c("Using gender data for analysis, communications and policy making in the context of SDG monitoring and beyond",
#            "Principles of Data Visualization for Official Statistics and SDG Indicators",
#            "Principles of Machine Learning for Official Statistics and SDGs", 
#            "Health Statistics for Monitoring Sustainable Development Goals (SDGs) - 2022",
#            "Introduction to the System of Environmental Economic Accounting-Central Framework", 
...
#            "Using administrative data to produce official statistics ", 
#            "Principles of Reproducible Analytical Pipelines for Official Statistics"),
#    Starts = as.Date(c("2022-05-25", "2022-01-24", "2022-06-06", "2022-07-04", "2022-08-01", 
#                      "2022-09-26", "2022-11-21", "2023-01-16", "2023-07-03", "2023-11-27", 
#                      "2024-04-29", "2024-06-01", "2024-08-12", NA, "2025-01-20", "2025-02-17")),
#   NbMod = c(3, 6, 6, 5, 5, 7, 8, 6, 7, 8, 5, 4, 6, 6, 6, 4),
#   GradeMax = 100,
#   Threshold = 70, 
#   Webinar = 4 # Sunday is 1, Wednesday is  4 
# )
# 
# write.csv(AllCourses, file = "AllCoursesSIAP.csv")
# 
...
## Manual Modules definition  (use actame created later)
ModStartIdx <- c(1,3,4)  # Parameters for ROS - 3 modules !
...
Below is a table with the`r NbActivities` pedagogical activities proposed in the course, excluding pdfs and other resources to download. 
...
Certified people come from **`r NbCountries` different countries**. The country with most certified is `r BestCountry` with  `r NbBestCountry` certified participants.
...
GradesPositive %>%
 ...
 labs(x="Grades", y=" Nb of sucessful learners",
      ...
      subtitle = paste0("(as of ", format(FileDate, "%A %d %B"),", ",
...
> It is still difficult to measure precisely the time spent by learners on the LMS,  but **`r NbLearners3hours`**  learners have spent more than 3 hours/Module on the course  *(`r round(100*NbLearners3hours/NbLearners,1)` \% )*.
