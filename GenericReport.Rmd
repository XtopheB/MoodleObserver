...
AllCoursesStartDate <-c("2022-05-25", "2022-01-24", "2022-06-06", "2022-07-04", "2022-08-01", "2022-09-26", "2022-11-21", "2023-01-16", "2023-07-03", "2023-11-27", "2024-04-29", "2024-06-01")
AllCoursesNbModules <-c(3,6,6,5,5,7,8,6,7,8, 5, 4)
```
...
GradeMax = 40  # 4 tests with max 10
...
# Need to adjust name of Total grade (sometimes Total..Real)
NameSex <- data.grades %>%
  mutate(TotalReal =  as.numeric(Grand.Total..Real.)) %>%
