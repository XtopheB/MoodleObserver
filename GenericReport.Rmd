...
```
```{r SuccessRateWomen}
successFemale <-  CertifiedSex["Female"]$'Nb of Certificates' / NbWomen
successMale <- CertifiedSex["Male"]$'Nb of Certificates' / (NbLearners - NbWomen)

```

The success rate for women is of  `r  CertifiedSex["Female"]$'Nb of Certificates' / NbWomen`  \% , larger than for men (
