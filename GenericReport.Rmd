...
```{r ActivityByDate}
# Specific to Facilitaed courses
# course.log %>%
...
course.log %>%
 filter(!is.na(ActNb))  %>%
  mutate(ActID.lab = paste("Mod-",str_trunc(Actname, 15, "right") )) %>%
