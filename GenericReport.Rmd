...
With that definition, excluding the "*no-shows*", the success rate for women is `r  SuccessRates$Rate[SuccessRates$Sex == "Female"]` \% , larger than for men ( `r SuccessRates$Rate[SuccessRates$Sex == "Male"]` \% )
