...
AllCoursesStartDate <-c("2022-05-25", "2022-01-24", "2022-06-06", "2022-07-04", "2022-08-01", "2022-09-26", "2022-11-21", "2023-01-16", "2023-07-03", "2023-11-27", "2024-04-29", "2024-06-01", "2024-08-12", "","2025-01-20")

AllCoursesNbModules <-c(3,6,6,5,5,7,8,6,7,8, 5, 4, 6, 6, 6)
```
...
# Sometimes one want to remove countries with less than XXX lezarners
MinNbLearners <- 7

message <- ifelse(cond,
                  paste("For better readability, data from", temp_country$Country[1], "(",temp_country$Learners[1], "obs) has been removed\n as well as countries with less than",MinNbLearners,"participants.\n "),
                  "" )
# Stats for text
...
# Graphic 
temp_country %>%
slice(ifelse(cond, -1, 1:n())) %>%   # to remove "large" countries 
