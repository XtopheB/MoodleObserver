...
> **Warning**: For each module, there are 3 elements on the LMS:
* The Articulate file (Interactive ppt)
* The pdf with the slides
* The pdf with questions and answers
 The activity of main interest here is realte to the Articulate viewing. The files records the date of the last (or first) click on the file. This is the information we want. 
 
##  Modules activity

**TBC**
 
## Pdfs downloads and completion for each module
...
In this grahic, each line is a participant and each cell show the activity of the particpant: It could be:
*  Green = Articulate view
*  light blue =  Pdf download
*  white: No activity
Ordering: 
Horizontal: Sequence of Modules
Vertical: Participant should be ranked according to there overall partcipation for most active to inactive.
