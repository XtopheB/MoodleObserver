...
Each course is specific in its form and in the organisation of each Module and the number of activities proposed. After cleaning and refining the data, we  identified  **`r length(unique(course_log$Actname))`**  different *activities* (information or resources such as videos, tutorials,  forums, articles, tests, polls,..) proposed for the learners in **7** modules. 

Below is table summarizing the repartition of the specific pedagogical activities by Module. 
...
Grades %>%
 ...
 labs(x="Nb of activities viewed", y=" Total Grade (over 65)", 
