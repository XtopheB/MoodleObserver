...
>The data can be downloaded for the Course management page> reports or that the ardress
...
# Some activities ave : in the name so Actname must be adjusted
course_log <- course_log  %>%
